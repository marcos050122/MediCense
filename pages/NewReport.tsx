...
const NewReport: React.FC = () => {
  ...
  return (
    <div className="p-4 space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-800 mb-1">Nuevo Registro</h2>
        <p className="text-slate-500 text-sm">Ingrese los datos recibidos de la llamada.</p>
      </div>
        ...
        <div className="p-4 bg-slate-50 border-b border-slate-100">
           ...
           <div className="relative">
             ...
             <input
               ...
               placeholder="Ej: Detrás de la parada El Club"
